...
namespace CV_storage.Data.Migrations
{
    ...
    [Migration("20240122140646_AdditionalInfoSectionAdded")]
    partial class AdditionalInfoSectionAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CV_storage.Core.Models.AdditionalInformation", b =>
                {
                    ...
                    b.Property<string>("MessageToHiringManager")
                        .HasMaxLength(1875)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CV_storage.Core.Models.AdditionalInformation", b =>
                {
                    b.HasOne("CV_storage.Core.Models.CurriculumVitae", "CurriculumVitae")
                        ...
                        .HasForeignKey("CV_storage.Core.Models.AdditionalInformation", "CurriculumVitaeId")
